        ...
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="max-w-2xl">
            ...
            <div className="mt-10 flex gap-4">
              <Link href="/products" className="btn-primary bg-white text-gray-900 hover:bg-gray-100">
                Shop Now
              </Link>
              <Link href="/about" className="btn-secondary border-gray-600 text-white hover:bg-white/10">
                Learn More
              </Link>
            </div>
          </div>
        ...
        {hasProducts ? (
          ...
          <div className="mt-8 rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              Set <code className="rounded bg-gray-100 px-1 py-0.5 text-xs">PRINTIFY_API_TOKEN</code> and{" "}
              <code className="rounded bg-gray-100 px-1 py-0.5 text-xs">PRINTIFY_SHOP_ID</code> in
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-medium">Custom Designs</h3>
              <p className="mt-2 text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-medium">Quality Guaranteed</h3>
              <p className="mt-2 text-sm text-gray-600">
